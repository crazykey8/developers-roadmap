...
- **`toSpliced`**:
 ...
 Возвращает новый массив с внесёнными изменениями, не изменяя исходный массив.
...
Мемоизация — это техника оптимизации, при которой результаты вызовов функций с одинаковыми аргументами сохраняются и возвращаются при последующих вызовах с этими же аргументами.
